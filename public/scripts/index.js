...
let classSec = ['hidden-bottom', 'spot-bottom', 'spot', 'spot-top', 'hidden-top']; //class order for menu homepage
let rotNum   = 0;
let home     = true; // handle keyboard click while on page section;
let idxPage;
let stillLoad = true;
let dotIdx = 0;
